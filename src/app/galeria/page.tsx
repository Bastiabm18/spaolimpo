  ...
  return (
    <section id="tienda" className="w-full px-4 md:px-8 overflow-hidden">
      ...
      >
        ...
        <motion.h2
          className="
            font-bold font-alumniSans text-4xl md:text-5xl uppercase tracking-wider mb-1
        ...
        <motion.div
          className="
            relative w-full aspect-video p-3 bg-black/20 h-[48vh]
        ...
        <motion.div className="flex justify-center gap-3 mt-3" variants={itemVariants}>
